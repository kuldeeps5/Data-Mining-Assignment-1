In this assignment Dependencies are the files that are used in each files, and it generate some output files which are 
there in Generates Output File section.

NOTE : All the code run in Python3 environment. Before running code, install all the plugins in python3.
...
=====================================================================================================================
NOTE : For individual run of the code first run the codes that generates the dependencies used. Then run the 
particular code.

=====================================================================================================================

Compile and run report.tex to generate the report of the assignment.

=====================================================================================================================

For visualisation of graph simply run graph.py
